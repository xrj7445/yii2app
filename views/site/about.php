...
/* load template CSS */
AppAsset::addCss($this,Yii::$app->request->baseUrl."/user_dashboard_theme/css/bootstrap.css");
AppAsset::addCss($this,Yii::$app->request->baseUrl."/user_dashboard_theme/css/font-awesome.css");
AppAsset::addCss($this,Yii::$app->request->baseUrl."/user_dashboard_theme/css/style.css");
/* load custom CSS */
AppAsset::addCss($this,Yii::$app->request->baseUrl."/user_dashboard_theme/css/custom-style.css");
/* */
AppAsset::addScript($this,Yii::$app->request->baseUrl."/user_dashboard_theme/js/bootstrap.js");
AppAsset::addScript($this,Yii::$app->request->baseUrl."/user_dashboard_theme/js/jquery-1.11.1.js");
?>
    ...
    <!-- HEADER END-->
    <div class="navbar navbar-inverse set-radius-zero banner">
        <div class="container-2">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php">
                    <img class="header-brand" src="user_dashboard_theme/img/header-brand.png" />
                </a>
            </div>
                      ...
                      <div class="notice-board">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                <a href="#" class="btn btn-default btn-block"> <i class="glyphicon glyphicon-repeat"></i> Footer Button</a>
                            </div>
                        </div>
                    </div>
                    <hr />
